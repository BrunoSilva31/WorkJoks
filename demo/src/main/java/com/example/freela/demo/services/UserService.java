...
public class UserService {
    ...
    private void validarHorario(String date) {
        ...
        // Verificar se o dia da semana está disponível para agendamento
        if (!diasDisponiveis.contains(diaSemana)) {
            throw new IllegalArgumentException("Dia não disponível para agendamento.");
        }
        
        // Verificar se o horário está dentro dos limites permitidos para agendamento
        ...
        // Verificar se o horário de agendamento é no futuro
    ...
    private void validarCapacidade(String horarioAgendamento, String ambiente) {
        ...
        // Verificar a capacidade do mezanino
        ...
        // Verificar a capacidade da varanda
